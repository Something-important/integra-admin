...
export async function PUT(
  ...
  try {
    ...
    // Admin interface - allow any authenticated user to update properties
    // Note: In production, you might want to add proper admin role checking here
...
export async function DELETE(
  ...
  try {
    ...
    // Admin interface - allow any authenticated user to delete properties
    // Note: In production, you might want to add proper admin role checking here
